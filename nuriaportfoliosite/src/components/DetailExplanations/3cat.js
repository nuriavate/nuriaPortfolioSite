            ...
            <div className="w-full mx-auto max-w-7xl px-6 lg:px-8">
                <div className="grid gap-6 lg:grid-cols-[0.9fr_1.1fr] lg:items-start lg:gap-8">
                    <div className="space-y-3">
                        ...
                        <p className="font-raleway">The onboarding experience was designed to introduce the platform while identifying usersâ€™ preferences and interests in order to personalise the experience. The process is simple and fast, reducing friction and preventing fatigue during the first interaction.</p>
                    </div>
            ...
            <div className="w-full mx-auto mt-12 max-w-7xl px-6 lg:px-8">
                <div className="grid gap-6 lg:grid-cols-[0.9fr_1.1fr] lg:items-start lg:gap-8">
                    <div className="space-y-3">
                        ...
                        <p className="font-raleway">Drops are rewards unlocked while watching live content. They appear as QR codes that users scan with their mobile devices to receive exclusive items, such as profile wallpapers.</p>
                    </div>
            ...
            <div className="w-full mx-auto mt-12 max-w-7xl px-6 lg:px-8">
                <div className="grid gap-6 lg:grid-cols-[0.9fr_1.1fr] lg:items-start lg:gap-8">
                    <div className="space-y-3">
                        ...
                        <p className="font-raleway">Live chats allow users to interact and actively participate during live sessions. They can be personalized to enhance the individual user experience and can also be accessed on mobile devices via QR code.</p>
                    </div>
            ...
            <div className="w-full mx-auto mt-12 max-w-7xl px-6 lg:px-8">
                <div className="grid gap-6 lg:grid-cols-[0.9fr_1.1fr] lg:items-start lg:gap-8">
                    <div className="space-y-3">
                        ...
                        <p className="font-raleway">Providing editable profiles allows users to express their identity within the platform. They can customise profile photos and wallpapers inspired by their favourite shows, reinforcing personalisation and engagement.</p>
                    </div>
            ...
            <div className="w-full mx-auto mt-12 max-w-7xl px-6 lg:px-8">
                <div className="grid gap-6 lg:grid-cols-[0.9fr_1.1fr] lg:items-start lg:gap-8">
                    <div className="space-y-3">
                        ...
                        <p className="font-raleway">Games inspired by usersâ€™ favourite shows help them feel part of the experience.</p>
                    </div>
            ...
            <div className="w-full mx-auto mt-12 max-w-7xl px-6 lg:px-8">
                <div className="grid gap-6 lg:grid-cols-[0.9fr_1.1fr] lg:items-start lg:gap-8">
                    <div className="space-y-3">
                        ...
                        <p className="font-raleway">Recat is a personalized video recap of usersâ€™ most-watched content, providing insights into their viewing habits and enhancing engagement and retention.</p>
                    </div>
