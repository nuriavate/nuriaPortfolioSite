    ...
    return (
        <div>
            <DetailSection titleh1={"Problem Statement"} rightContent={
                <div className="grid gap-y-4 font-raleway">
                    <p>
            ...
            <DetailSection titleh1={"Target Audience"} rightContent={<p className="font-raleway">The target audience was the Catalan population across all age groups. However, the project placed special emphasis on young people, who showed the lowest retention rates. Considering users of all ages and backgrounds was essential to ensure inclusivity and avoid exclusion.
            </p>} />
            ...
            <DetailSection titleh1={"Process"} rightContent={
                <div className="grid gap-y-4 font-raleway">
                    ...
                    <ol className="grid gap-y-4 font-raleway">
            ...
            <hr className="my-4 border-t border-[#270400]/10" />
            <DetailSection titleh1={"Final Ideas"} rightContent={<p className="font-raleway">The final features address different user needs, enhancing exploration, motivation, personalisation, and interaction with the content. As a result, they increase overall user engagement with the platform.
            </p>} />
            <div className="w-full mx-auto max-w-7xl px-0 sm:px-6 lg:px-8">
                ...
                <p className="font-raleway">The onboarding experience was designed to introduce the platform while identifying users’ preferences and interests in order to personalise the experience. The process is simple and fast, reducing friction and preventing fatigue during the first interaction.</p>
                <FeatureVideo src={"https://res.cloudinary.com/dbv5idped/video/upload/v1771854473/2026-02-23-13-29-11_uapvyp.mp4"}></FeatureVideo>
            </div>

            <div className="w-full mx-auto max-w-7xl px-0 sm:px-6 lg:px-8">
                <h1 className="font-urbanist text-3xl font-semibold tracking-tight text-[#270400] sm:text-2xl">Emotion Searcher</h1>
                <p className="font-raleway">The emotion-based search allows user to discover content according to their emotional state rather than traditional categories and genres.</p>
                <FeatureVideo src={"https://res.cloudinary.com/dbv5idped/video/upload/v1771854584/2026-02-23_14-24-02_dtqi3e.mkv"}></FeatureVideo></div>
            <div className="w-full mx-auto max-w-7xl px-0 sm:px-6 lg:px-8">
                <h1>Drops</h1>
                <p>Drops are rewards unlocked while watching live content. They appear as QR codes that users scan with their mobile devices to receive exclusive items, such as profile wallpapers.</p>
                <FeatureVideo src={"https://res.cloudinary.com/dbv5idped/video/upload/v1771854634/2026-02-23_14-32-18_ifkl1t.mkv"}></FeatureVideo>
            </div>

            <div className="w-full mx-auto max-w-7xl px-0 sm:px-6 lg:px-8">
                <h1>Live Chat</h1>
                <p>Live chats allow users to interact and actively participate during live sessions. They can be personalized to enhance the individual user experience and can also be accessed on mobile devices via QR code.</p>
                <FeatureVideo src={"https://res.cloudinary.com/dbv5idped/video/upload/v1771855087/2026-02-23_14-57-06_ewrmeo.mkv"}></FeatureVideo>
            </div>

            <div className="w-full mx-auto max-w-7xl px-0 sm:px-6 lg:px-8">
                <h1>Edit Profile</h1>
                <p>Providing editable profiles allows users to express their identity within the platform. They can customise profile photos and wallpapers inspired by their favourite shows, reinforcing personalisation and engagement.</p>
                <FeatureVideo src={"https://res.cloudinary.com/dbv5idped/video/upload/v1771855360/2026-02-23_15-00-23_oqjtoq.mkv"}></FeatureVideo>
            </div>

<div className="w-full mx-auto max-w-7xl px-0 sm:px-6 lg:px-8">
      <h1>Game "Atrapa'm si pots"</h1>
      <p>Games inspired by users’ favourite shows help them feel part of the experience.</p>
            <FeatureVideo src={"https://res.cloudinary.com/dbv5idped/video/upload/v1771855370/2026-02-23_15-01-30_ectdiy.mkv"}></FeatureVideo>
</div>
          
          <div className="w-full mx-auto max-w-7xl px-0 sm:px-6 lg:px-8">
             <h1>Recat and Calendar</h1>
             <p>Recat is a personalized video recap of users’ most-watched content, providing insights into their viewing habits and enhancing engagement and retention.</p>
            <FeatureVideo src={"https://res.cloudinary.com/dbv5idped/video/upload/v1771855836/2026-02-23_15-07-40_yeqlyg.mkv"}></FeatureVideo>
          </div>
           
            <hr className="my-4 border-t border-[#270400]/10" />

            <DetailSection titleh1={"Usability Test"} rightContent={<div className="font-raleway"><p>We conducted a usability test with five users to evaluate the emotion-based search engine, the game Atrapa’m si pots, and the overall layout. Participants were asked to search content based on their current emotion and interact with the game to assess usability and engagement.
            </p></div>}></DetailSection>
